import { ChangeDetectionStrategy, Component,  DestroyRef,  Signal, WritableSignal, computed, effect, inject } from '@angular/core';
...
export class BikeListComponent {
  ...
  private readonly searchValueDebounced$: Observable<string> = toObservable(this.searchValue).pipe(
    debounceTime(400),
  ...
  private updateQueryParamsEffect(): void {
    effect(() => {
      this.router.navigate([], {
        ...
        queryParams: { page: this.currentPage(), location: this.currentLocation() },
