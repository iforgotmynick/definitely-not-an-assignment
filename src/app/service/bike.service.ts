...
export class BikeService {
  ...
  private readonly bikeId: WritableSignal<number | null> = signal<
    number | null
  >(null);
  ...
  readonly bikeListResource: Resource<BikeList | undefined> =
    httpResource<BikeList>(() => {
  ...
  readonly bikeListCountResource: Resource<BikeCount | undefined> =
    httpResource<BikeCount>(() => {
      const location = this.location();
      let params = new HttpParams();
  ...
  readonly bikeResource: Resource<{bike: BikeFull} | undefined> = httpResource<{
    bike: BikeFull;
  }>(() => {
